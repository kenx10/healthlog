...
import evg.echo.healthlog.ui.components.widgets.sliders.PainSlider
import org.koin.compose.koinInject


@Composable
fun AddMigraineScreen(
    navController: NavHostController,
    measureService: MeasureService = koinInject<MeasureService>()
) {
    var durationValue by remember { mutableFloatStateOf(20f) }
    var painValue by remember { mutableIntStateOf(R.mipmap.mig_low) }
        ...
        Box(modifier = Modifier.padding(paddingValues)) {
            ...
            Column(
                ...
                Button(
                    onClick = {
                        // save
                        val pain = when (painValue) {
                            R.mipmap.mig_low -> 1
                            R.mipmap.mig_middle -> 2
                            R.mipmap.mig_high -> 3
                            else -> 0
                        }
